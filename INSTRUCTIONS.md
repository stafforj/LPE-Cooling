...
The hardware design is based on the thermal loads that need to be dissipated from the liquid exfoliation system. In this build we use a 350W Kenwood BLP31.D0WG blender. We operate for a process time of $t \approx 15$mins.
