...
In this build, the components are exposed to water and ice. Although PETG is compatible with this, the layers in the FDM process can create sites for fluid leakages. To remove the risk of leakages, the 3D printed parts were coated with a thin film silicon-based conformal coating (three spray coats ~ 100 $\mu$m thickness). To illustrate this, a sample part was 3D printed, masked, and partially covered with a single spray coat (~ 25 $\mu$m). The difference between the coated and uncoated PETG surface is shown in the image below. The conformal coating covers the layers and seals the print.  
